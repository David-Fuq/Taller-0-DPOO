...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consular el pa�s de origen de un atleta");
	...
	{
		String elAtleta = input("Por favor indique el nombre del atleta del cual desea conocer la nacionalidad");
		Pais elPais = calculadora.buscarPaisAtleta(elAtleta);
		System.out.println("La naci�n representada por "+elAtleta+" es "+elPais.darNombre());
	}
